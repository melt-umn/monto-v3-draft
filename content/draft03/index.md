+++
title = "Monto Version 3 Specification, Draft 3"
+++

# Draft 4 TODOs

 - Design, Document, Implement Configuration
   - Client Protocol
     - global config in broker, stateful and persisted
	 - per-client stateless config
   - Service Protocol
     - stateless
...
{{% draft03-message 3 1 1 Identifier %}}
{{% draft03-message 3 1 2 NamespacedName %}}
{{% draft03-message 3 1 3 Product %}}
{{% draft03-message 3 1 4 ProductDescriptor %}}
{{% draft03-message 3 1 5 ProductIdentifier %}}
{{% draft03-message 3 1 6 ProductName %}}
{{% draft03-message 3 1 7 ProtocolVersion %}}
{{% draft03-message 3 1 8 SoftwareVersion %}}
...
{{% draft03-message 4 5 1 ClientNegotiation %}}
{{% draft03-message 4 5 2 ClientBrokerNegotiation %}}
{{% draft03-message 4 5 3 BrokerPutError %}}
{{% draft03-message 4 5 4 BrokerGetError %}}
...
If there are `meta` items on the input Products, they MUST be included in the `meta` items on the output Product, unless the Service can determine that the `meta` item being removed is irrelevant.

## 5.4. Service Protocol Messages

{{% draft03-message 5 4 1 ServiceBrokerNegotiation %}}
{{% draft03-message 5 4 2 ServiceNegotiation %}}
{{% draft03-message 5 4 3 BrokerRequest %}}
{{% draft03-message 5 4 4 ServiceErrors %}}
{{% draft03-message 5 4 5 ServiceProduct %}}
{{% draft03-message 5 4 6 ServiceNotice %}}
...
{{% draft03-product 6 1 directory %}}
{{% draft03-product 6 2 errors %}}
{{% draft03-product 6 3 highlighting %}}
{{% draft03-product 6 4 source %}}
